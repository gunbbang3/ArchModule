...
* 초기값이 없는 변수들의 처리
  ...
  * 명백하게 초기화하는 것이 바람직한 습관
  ...
  ![ScopeLifeTime-VarInitialization](/assets/images/ScopeLifeTime-VarInitialization.svg)
...
![ScopeLifeTime-FuncLocalVar](/assets/images/ScopeLifeTime-FuncLocalVar.svg)
